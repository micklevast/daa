...
// // tc and SC
// The time complexity of the above algorithm in the average case is of O(NlogN) while in worst case it gives the time complexity of O(N ^ 2).The space complexity is O(K)
// as extra space is used to store the convex hull points where K is the number of points in the convex hull.
